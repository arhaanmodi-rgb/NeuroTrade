...
> **IMPORTANT NOTICE**: This project is strictly for **educational, academic, and AI/ML research demonstration purposes**.
> 
> * **Not Financial Advice**: Nothing in this application or codebase constitutes financial, investment, legal, or tax advice.
> * **Not SEBI Registered**: The developers and contributors are not SEBI-registered financial advisors, broker-dealers, or research analysts.
> * **AI/ML Model Limitations**: The trading signals, neural Q-values, and predictive metrics generated by the Deep Q-Network models are experimental simulations. Financial markets involve substantial risk of loss. **Do not depend on this system or deploy real monetary capital based on its predictions.**
